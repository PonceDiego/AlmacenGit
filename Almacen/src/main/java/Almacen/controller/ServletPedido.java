...
public class ServletPedido extends HttpServlet {
	...
	//	request.getRequestDispatcher("/view/pedidoEspecifico.jsp").forward(request, response);
		...
		request.getSession().setAttribute("pedidoArea", PedidoDB.getPedidoByID(id).getUsuario().getArea().getNombreArea());
		request.getSession().setAttribute("pedidoUsuario", PedidoDB.getPedidoByID(id).getUsuario().getNombreUsuario());
		request.getSession().setAttribute("pedidoEstado", PedidoDB.getPedidoByID(id).getEstadopedido().getNombreEstado());
