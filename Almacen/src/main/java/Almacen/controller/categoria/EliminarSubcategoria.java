 ...
 */
@WebServlet("/EliminarSubcategoria")
public class EliminarSubcategoria extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (session.getAttribute("usuarioActual") == null) {
			...
			SubcategoriaDB.deleteSubcategoriaById(id);
