...
public class MailManager {
	...
	public static void enviarMail(String userS, int idp)
		...
		String subject = "Se ha realizado un nuevo pedido en el �rea " + u.getArea().getNombre() + ".";
		...
		String messageBody = "\n Este mensaje ha sido generado autom�ticamente por el Sistema Almacen.";
	...
	public static void mailLlaves(int idUserString, int idLlave, int idEncargadoString) throws MessagingException {
		...
		String bodyText = "Estimado/a " + solicitante.getNombre() + ", el usuario " + encargado.getNombreUsuario()
				...
				+ "Si considera que esto es un error, por favor comun�quese con el encargado a la brevedad.\n"
