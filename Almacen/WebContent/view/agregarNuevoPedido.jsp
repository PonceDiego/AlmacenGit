				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown active"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown1">
							<a class="dropdown-item active" href="../GenerarPedido">Nuevo pedido</a> <a
			...
			<div class="card-body">
				...
				<div class="row">
					...
					<div class="column">
						...
						</select> <input style="border-radius: 5px" type="text" id="cantidad" placeholder="Cantidad"
					...
					<div class="column">
						...
						<span id=charcount style="font-size: small;">0/140</span> <span
							onclick="submit()" 
							class="aceptarBtn">Aceptar</span>
					</div>
