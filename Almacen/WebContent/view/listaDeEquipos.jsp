...
<body>
	...
	<div class="container">
		<div class="col-lg-12 text-center">
			<h1 class="mt-5">Lista de equipos.<span><a href="../ListaLugares" style="font-size: small;"> Lugares 🡕</a></span><span><a href="../ListaTipos" style="font-size: small;">Tipos 🡕</a></span></h1>
					...
					<c:forEach items="${equipos}" var="equipo">
						<tr>
							...
							<c:forEach items="${registros }" var="re">
								<c:if test="${re.getEquipo().getNombre()== equipo.getNombre() }">
	...
	<script>
		function alertar(url) {
			alert("Realizando cambio de estado del equipo..");
