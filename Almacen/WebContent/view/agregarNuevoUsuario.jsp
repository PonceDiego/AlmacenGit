		...
		<div class="card card-signin my-5">
			<div class="card-body">
				<form class="form-signin" method="post" action="../UsuarioNuevo">
					...
					<div class="row">
						<div class="column">
							...
							<div class="form-label-group>">
								<input tabindex="1" type="text" name="inputUsername"
									class="form-control" placeholder="Nombre de Usuario" required
									autocomplete="off" onchange="comparar()">
							</div>
							<div>Nombre</div>
							<div class="form-label-group>">
								<input tabindex="3" type="text" name="inputNombre"
									class="form-control" placeholder="Nombre" required
									autocomplete="off">
							</div>
							<div>Área</div>
							<div class=" form-label-group>" id="area">
								<input type="hidden" id="inputArea" required
									class="form-control"> <input type="hidden"
									id="inputRol" required class="form-control"> <select
									tabindex="5" name="selectArea" onchange="selected(),comparar()"
									id="selectArea"
						...
						<div class="column">
							...
							<div class="form-label-group>">
								<input tabindex="2" type="text" name="inputMail"
									class="form-control" placeholder="Mail" required
									autocomplete="off">
							</div>
							...
							<div>Apellido</div>
							<div class="form-label-group>">
								<input tabindex="4" type="text" name="inputApellido"
									class="form-control" placeholder="Apellido" required
									autocomplete="off">
							</div>
							<div>Rol</div>
							<div class="form-label-group>">
								<select tabindex="6" name="selectRol"
									style="border-radius: 5px; font-size: 16px; padding: 5px; min-width: 50%"
									required onchange="selected2(),comparar()" id="selectRol">
					...
					<hr>
					<button tabindex="7"
						class="btn btn-lg btn-primary btn-block text-uppercase" disabled
						id="aceptarbutton"
