							...
							<c:if
								...
								<c:if
									...
									<a class="dropdown-item" href="../UsuarioNuevo">Nuevo
										usuario</a>
									<a class="dropdown-item active" href="../AreaNueva">Nueva Área</a>
				...
				<form class="form-signin" method="post" action="../EditarArea">
					...
					<div class="row">
						<div class="column">
							...
							<input type="hidden" name="inputId" value="${areaEditar.getAreaId() }">
							...
							<div class=" form-label-group>">
								<select name="inputJefe"
									...
									<c:forEach items="${usuarios}" var="usuario">
										<c:choose>
											<c:when
												test="${usuario.getNombreUsuario()==areaEditar.getUsuario().getNombreUsuario() }">
