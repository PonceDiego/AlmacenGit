	...
	<div class="text-center">
		<c:if test="${mostrarBoton }">
			<form method="get" action="../CambioEstado" id="formMethod">
				<input type="hidden" id="cambioId" name="cambioId" value="${grupoLlaves.getGrupoId()}"> 
				<input type="hidden" id="salida" name="salida" value="${grupoLlavesEstado == 'En uso' ? '0' : '1'}"> 
				<input type="hidden" id="entidad" name="entidad" value="GrupoLlaves">
				<c:choose>
					<c:when test="${grupoLlavesEstado == 'Disponible'}">
						...
						onclick="setDataModal('${grupoLlaves.getGrupoId()}','${grupoLlavesEstado}')"
						>Salida</button>
					...
					<c:when test="${grupoLlavesEstado == 'En uso'}">
						<button class="btn btn-primary btn-lg mb-1" type="submit" title="Entrada" style="cursor: pointer">Entrada</button>
					</c:when>
				</c:choose>
			</form>
		</c:if>
				...
				<div>
					<form method="get" action="../CambioEstado" id="formMethod">
						<div class="form-inline mt-2 ml-2 mb-2 mx-2 ">
							...
							<input type="hidden" id="entidadModal" name="entidad" value="GrupoLlaves">
