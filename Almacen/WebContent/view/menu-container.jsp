				...
				<c:if test="${usuarioActual.getRol().getNombre()=='SuperAdmin'||usuarioActual.getRol().getNombre()=='Administrador'}">
					<li id="MenuProveedores" class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a id="ListaProveedores" class="dropdown-item" href="../ListaProveedores">Listar por artículos</a>
							<a id="BuscarProveedor" class="dropdown-item " href="../BuscarProveedor">Proveedor específico</a>
						</div>
					</li>
				</c:if>
