...
<body>
	<jsp:include page="menu-container.jsp">
		<jsp:param name="activeMenu" value="BuscarProveedor" />
	</jsp:include>
		...
		<div class="card card-signin my-5">
			<div class="card-body">
				<form class="form-signin" method="post" action="../Proveedor">
					...
					<div class="row">
						<div class="column">
							<div class=" form-label-group> searchable">
								<input type="text" placeholder="Buscar proveedor" name="nombreProveedor" id="nombreProveedor" onchange="comparar()" onkeyup="filterFunction(this,event),botonAceptar()" required autocomplete="off">
					...
					<hr>
					<button class="btn btn-lg btn-primary btn-block text-uppercase" id="aceptarbutton" disabled="disabled" style="max-width: 50%; margin: auto; background-color: #f37321; cursor: pointer;">Aceptar</button>
				</form>
			</div>
		</div>
