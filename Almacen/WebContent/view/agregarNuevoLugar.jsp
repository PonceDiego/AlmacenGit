		...
		<div class="card card-signin my-5">
			<div class="card-body">
				<form class="form-signin" method="post" action="../Lugar">
					...
					<div class='text-center' id="advertencia" style="color: red"></div>
						<hr class="m-4">
						<div class="row">
							<div class="column">
								...
								<div class="form-label-group> searchable">
									...
									<c:set var="articulo" value="${listaLugares }"></c:set>
									<ul id="ulArticulos">
								...
								<div class="form-label-group>">
									<input type="text" name="inputDes" class="form-control"
										placeholder="Descripción" autocomplete="off" maxlength="50">
								</div>
